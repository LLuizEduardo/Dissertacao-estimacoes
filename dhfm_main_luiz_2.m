...
%n_burn=200; n_keep=200; n_skip=20; n_gibbs=n_burn+n_keep;
n_burn=2000; n_keep=2000; n_skip=10; n_gibbs=n_burn+n_keep;
...
matname=['dhfm_results_luiz_2'];

%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Load data 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load 'dhfm_data_luiz_2'
